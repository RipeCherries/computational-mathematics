...
| Реализовать программу, позволяющую примерно вычислить значение функции в точке. Функция задаётся в виде соответствий :math:`x\;y(x)`. Соответствия берутся из файла.
